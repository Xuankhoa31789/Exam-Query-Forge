...
Exam Query Forge — shared question pool, collaborative voting, matrix-based exam assembly.
...
Slice order:
1. **Auth & User** — Subject/User/Credential entities, repos, BCrypt, basic security.
...
- [x] **Slice 1 — Auth & User: DONE** — JPA, Security, H2 database, User/Credential/Subject entities with enums, BCrypt password hashing, email-based login/registration (tested).
